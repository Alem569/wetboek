...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Rotterdam |
| Officiële naam regeling   | Algemene Plaatselijke Verordening Rotterdam|
| Citeertitel               | Algemene Plaatselijke Verordening Rotterdam|
| Vastgesteld door          | De Hoge Raad|
| Onderwerp                 | Openbare orde en veiligheid|

### Opmerkingen met betrekking tot de verordening

Het Wetboek van Strafrecht, specifiek bedoeld voor Rotterdam, wordt hierbij ingetrokken en vervangen door deze APV.
...
1. Aanvullend op de APV is er het Wetboek Rotterdam (WRPP), waarin alle wetten, artikelen en bepalingen zijn opgenomen die gelden in Rotterdam.
...
2. Dit Wetboek heeft, net als de APV, een basis in het Nederlands Recht.
   * Het Nederlands Recht is zodoende leidend, *tenzij* er een Wet of Bepaling is opgenomen in de WRRP. Dan is deze leidend.
...
7. Wanneer je met meerdere mensen die op Rotterdam spelen in een voice call zit is streamen niet toegestaan en moet je gedeafened en gemute zijn.
...
3. Officiële kleding verstrekt vanuit Rotterdam bedoeld voor specifieke groeperingen mogen niet door andere gebruikt worden tenzij hier sterke roleplay aan verbonden is.
...
3. Buiten de weg rijden mag, mits dit met matige snelheid gedaan wordt en met een geschikt voertuig, pas hierbij dus ook de snelheid aan voor het type voertuig. Een lijst met voertuigen is [hier](https://wetboek.Rotterdam.nl/offroadvoertuigen/) te vinden.
...
2. Bij een overtreding van de regel genoemd in lid 1 zal de persoon erop gewezen worden volgende keer gelieve “/report” te gebruiken of een ticket aan te maken in de Rotterdam Roleplay Discord.
...
1. Als politie of kmar is het niet toegestaan om criminele activiteiten te doen
...
8. Doe je indienst criminele activiteiten valt dit ook onder corruptie.
9. Op lid 7 geldt een uitzondering voor medewerkers van de politie of koninklijke marechaussee met een speciale vergunning. Deze leden mogen wel hun wapens buiten dienst behouden.
...
1. Onder "criminele organisaties" vallen alle officiële groepen gevestigd in Rotterdam.
...
6. Een voorwaarde voor het samenwerken tussen criminele organisaties is dat er geen volledige samenwerking tussen alle organisaties ontstaat en dat dit niet gebeurd tijdens het witwassen van geld. Dit is ter beoordeling van de Hoge Raad van Rotterdam.
7. Wanneer officiële organisaties een samenwerking aangaan met een andere officiële organisatie dan dient dit gemeld te worden volgens het [format](/apv/#bijlage-2) in het daarvoor aangemaakte kanaal in de Rotterdam Discord.
...
![bijlage-1](https://Rotterdam.nl/wp-content/uploads/2021/08/Schermafbeelding_2021-08-23_om_10.png)
...
---------------------
APV opgesteld uit naam van de Hoge Raad, bedoeld voor het eiland, de gemeente en de stad “Rotterdam”, opgetekend door Bram Mosterdfiets, te Rotterdam.
